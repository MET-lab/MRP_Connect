...
const float kWhiteKeyBackOffsets[] = {0, 0.22, 0.42, 0, 0.14, 0.3, 0.44, 0.22, 0};
const float kWhiteKeyBackWidths[] = {0.6, 0.58, 0.58, 0.56, 0.56, 0.56, 0.56, 0.58, 1.0};
...
const int kShapeForNote[] = {0, -1, 1, -1, 2, 3, -1, 4, -1, 5, -1, 6};
const int kWhiteToChromatic[] = {0, 2, 4, 5, 7, 9, 11};
const float kWhiteKeyFrontBackCutoff = (6.5 / 19.0); 

// Touch constants
const float kDisplayMaxTouchSize = 0.4;
